        ...
        try {
            ...
            if (isFullMix && isSEorDE) {
                ...
                try {
                    ...
                    console.log(`✅ Найдено ${Object.keys(rosters).length} команд с составами`);
                    console.log(`📋 Составы по командам:`, Object.keys(rosters).map(k => `Team ${k} (раунд ${rosters[k].round})`));
