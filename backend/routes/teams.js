...
// Публичный профиль команды и история матчей перенесены ниже, чтобы не перехватывать статические маршруты вроде /my-teams и /invitations
...
// Короткая история матчей для превью (должна идти после статических маршрутов)
