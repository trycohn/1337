      ...
      <div className="match-stats-container">
        <div className="match-header-container">
          ...
          <div className="match-header-inline">
            ...
            <img className="team-avatar" src={(playersByTeam?.team1?.[0]?.avatar_url || tournament?.teams?.find?.(t=>t.id===m.team1_id)?.avatar_url) || '/images/avatars/default.svg'} alt="team1" />
            ...
            <img className="team-avatar" src={(playersByTeam?.team2?.[0]?.avatar_url || tournament?.teams?.find?.(t=>t.id===m.team2_id)?.avatar_url) || '/images/avatars/default.svg'} alt="team2" />
